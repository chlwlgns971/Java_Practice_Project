...
public class DataIOTest {
	...
	public static void main(String[] args) {
		try {
			FileOutputStream fout=new FileOutputStream("d:/d_other/tset.dat");
			//자로형 단위로 출력할 DataOutputStream객체 생성
			...
			dout.writeUTF("ABCDabcd"); //문자열형식으로 데이터출력
			...
			//-------------------------------------------------------------------
			//출력했던 자료 읽어오기
			DataInputStream din=new DataInputStream(new FileInputStream("d:/d_other/tset.dat"));
