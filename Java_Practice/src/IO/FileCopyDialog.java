...
//         fin.close();
   ...
   // Dialog창을 띄워주고 선택한 파일 정보를 반환하는 메소드
   public File showDialog(String option) {

      // 자바 GUI의 발전
      // 자바의 GUI 환경 발전 순서 : AWT --> SWING --> JavaFX
      ...
      FileNameExtensionFilter img = new FileNameExtensionFilter("Images File", new String[] { "png", "jpg", "gif" });
      ...
      // Dialog창에 있는 '저장' 또는 '열기' 버튼을 눌렀을 때 경우 ...
