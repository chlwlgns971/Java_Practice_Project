...
public class URLTest02 {
	...
	public static void main(String[] args) throws IOException {
		...
		//URL에 지정된 해당 문서의 내용을 가져오기(index.php문서의 내용 가져오기)
...
//		//자료를 읽어와 출력하기
//		while(true) {
//			String str=br.readLine(); //한줄 씩 읽어오기
//			if(str==null) break;
...
//		br.close();
		...
		//자료를 읽어와 출력하기
		while(true) {
			String str=br2.readLine(); //한줄 씩 읽어오기
			if(str==null) break;
			System.out.println(str);
		}
		br2.close();
