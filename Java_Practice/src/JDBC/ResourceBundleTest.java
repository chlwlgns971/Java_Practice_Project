...
/*
 ResourceBundle객체->파일의 확장자가 properties인 파일의 내용을 읽어와 key값과 value값을 분리해서 정보를 갖고 있는 객체
 	=>읽어올 파일의 내용은 'key값=value값' 형태로 되어 있어야하고, 파일의 확장자는 반드시 properties여야 한다.
 */
public class ResourceBundleTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("user2: "+bundle.getString("user2"));
